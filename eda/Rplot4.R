...
png('C:/Users/Mas Mobiliario SAS/datasciencecoursera/exploratory_data_analysis/ExData_Plotting1/figure/plot4.png')
par(mfrow = c(2,2))

plot(subset_data$date_time, subset_data$Global_active_power, type = 'l', ylab  = 'Global Active Power', xlab = '', mar = c(1,1,1,1))
...
legend('topright', col = c('black','red','blue'), lwd = c(2,2,2), c('Sub_metering_1','Sub_metering_2', 'Sub_metering_3'),bty ='n')


plot(subset_data$date_time,subset_data$Global_reactive_power, type = 'l',xlab = 'datetime', ylab='Global Reactive Power', oma = c(1,1,1,1))
